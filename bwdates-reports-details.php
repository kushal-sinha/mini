...
<html lang="en">
    <head>
        ...
        <title>Nursery Management System || Between Dates Reports</title>
                  ...
                  <?php if($row['Status']==""){ ?>
                     ...
                     <?php } else { ?>
                      <td><?php  echo $row['Status'];?></td><?php } ?> 
                                    <td><a href="view-order.php?orderid=<?php echo $row['Ordernumber'];?>" class='btn btn-primary'>View Details</a></td>
                                        </tr>
                                        <?php $cnt=$cnt+1; } ?>
