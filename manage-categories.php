...
<html lang="en">
    <head>
        ...
        <title>Nursery Management System -Manage Category</title>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
<?php $query=mysqli_query($con,"select tblcategory.ID as catid,tblcategory.CategoryName,tblcategory.CategoryDescription,tblcategory.CreationDate,tbladmin.username from tblcategory join tbladmin on tbladmin.id=tblcategory.CreatedBy");
$cnt=1;
