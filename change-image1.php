...
$pid=intval($_GET['id']);
$sql=mysqli_query($con,"update tblproducts set productImage1='$imgnewfile', addedBy='$updatedby' where ID='$pid'");
unlink($imagepath);
...
<?php 
$pid=intval($_GET['id']);
$query=mysqli_query($con,"select tblproducts.productImage1,tblproducts.productName from tblproducts  where  tblproducts.ID='$pid' ");
