...
$pid=intval($_GET['id']);
$sql=mysqli_query($con,"update tblproducts set productImage2='$imgnewfile', addedBy='$updatedby' where id='$pid'");
unlink($imagepath);
...
<html lang="en">
    <head>
        ...
        <title>Nursery Management System || Change Image</title>
...
<?php 
$pid=intval($_GET['id']);
$query=mysqli_query($con,"select tblproducts.productImage2,tblproducts.productName from tblproducts  where  tblproducts.ID='$pid' ");
